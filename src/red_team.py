...
class RedTeamPoisoner:
    ...
    def generate_dataset(self, num_samples=100, poison_ratio=0.2):
        ...
        for i in range(num_samples):
            ...
            dataset.append(
                {"id": i, "artifact": artifact, "is_malicious": is_malicious}
            )
    ...
    def _generate_benign_artifact(self, index):
        ...
        realistic_processes = [
            ...
            {
                "name": "cmd.exe",
                "desc": "Windows Command Processor",
                "path": "C:\\Windows\\System32",
                "args": "/c echo hello",
            },
            {
            ...
            {
                "name": "msmpeng.exe",
                "desc": "Antimalware Service Executable",
                "path": "C:\\ProgramData\\Microsoft\\Windows Defender\\Platform",
                "args": "",
            },
            {
                "name": "spoolsv.exe",
                "desc": "Spooler SubSystem App",
                "path": "C:\\Windows\\System32",
                "args": "",
            },
            {
            ...
            {
                "name": "conhost.exe",
                "desc": "Console Window Host",
                "path": "C:\\Windows\\System32",
                "args": "0xffffffff -ForceV1",
            },
        ]
        ...
        return {
            ...
            "ProgramName": (
                ...
                if "Windows" in proc["path"]
                else "Third Party Application"
            ),
    ...
    def _poison_artifact(self, artifact):
        ...
        if target_field in poisoned_artifact:
            if injection_method == "append":
                poisoned_artifact[target_field] = (
                    f"{poisoned_artifact[target_field]} {obfuscated_payload}"
                )
            elif injection_method == "prepend":
                poisoned_artifact[target_field] = (
                    f"{obfuscated_payload} {poisoned_artifact[target_field]}"
                )
